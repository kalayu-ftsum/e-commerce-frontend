...
<footer className="py-10 px-10 font-sans tracking-wide">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-10 max-w-screen-xl mx-auto">
        <div>
          <Logo />
          <p className="text-sm mt-6 text-gray-500">Experience seamless shopping from the comfort of your home with our e-commerce platform, offering a vast selection of products at competitive prices. Enjoy fast, reliable shipping and hassle-free returns, making online shopping easier and more convenient than ever.</p>

          <ul className="mt-10 space-y-6">
            <li className="flex items-center">
              <div className="bg-[#e6e6e6cf] h-10 w-10 rounded-full flex items-center justify-center shrink-0">
                <svg xmlns="http://www.w3.org/2000/svg" width="20px" height="20px" fill='rgb(107 114 128)' viewBox="0 0 482.6 482.6">
                  <path
              ...
              <a href="javascript:void(0)" className="text-gray-500 text-sm ml-3">
            ...
            <li className="flex items-center">
              <div className="bg-[#e6e6e6cf] h-10 w-10 rounded-full flex items-center justify-center shrink-0">
                <svg xmlns="http://www.w3.org/2000/svg" width="20px" height="20px" fill='rgb(107 114 128)'
              ...
              <a href="javascript:void(0)" className="text-gray-500 text-sm ml-3">
                ...
                <strong>info@dressup.com</strong>
              </a>
            </li>
            <li className="flex items-center">
              <div className="bg-[#e6e6e6cf] h-10 w-10 rounded-full flex items-center justify-center shrink-0">
            ...
            <li className="flex items-center">
              <div className="bg-[#e6e6e6cf] h-10 w-10 rounded-full flex items-center justify-center shrink-0">
                <svg xmlns="http://www.w3.org/2000/svg" width="20px" height="20px" fill='rgb(107 114 128)' viewBox="0 0 100 100">
                  <path
        ...
        <div className="max-w-md md:ml-auto">
          ...
          <p className="text-sm text-gray-500 mt-2">We usually respond before 24 hours.</p>
          <form className="mt-6">
            ...
            <textarea placeholder='Message' rows={6}
              className="w-full rounded-md px-6 bg-[#f0f1f2] text-sm pt-3 outline-blue-500"></textarea>
          </form>
          <button type='button'
            className="text-white bg-gray-500 hover:bg-blue-600 font-semibold rounded-md text-sm px-6 py-3 block w-full mt-3">Submit</button>
        </div>

        <div>
          <h4 className="text-[#333] font-bold text-lg">Social Media</h4>
          <p className="text-sm text-gray-500 mt-2">Follow us for the latest updates and exclusive offers!</p>
          <ul className="flex items-center mt-6 space-x-4">
            <li className="bg-[#e6e6e6cf] h-10 w-10 rounded-full flex items-center justify-center shrink-0">
              <a href="javascript:void(0)">
                <svg xmlns="http://www.w3.org/2000/svg" width="20px" height="20px" fill='rgb(107 114 128)' viewBox="0 0 24 24">
                  <path
            ...
            <li className="bg-[#e6e6e6cf] h-10 w-10 rounded-full flex items-center justify-center shrink-0">
              <a href="javascript:void(0)">
                <svg xmlns="http://www.w3.org/2000/svg" width="20px" height="20px" fill='rgb(107 114 128)' viewBox="0 0 511 512">
                  <path
            ...
            <li className="bg-[#e6e6e6cf] h-10 w-10 rounded-full flex items-center justify-center shrink-0">
              <a href="javascript:void(0)">
                <svg xmlns="http://www.w3.org/2000/svg" width="20px" height="20px" fill='rgb(107 114 128)'
                  ...
                  <g fill="none" stroke="rgb(107 114 128)" stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10"
      ...
      <div className="max-w-screen-xl mx-auto">
        ...
        <div className="lg:flex lg:item-center">
          <ul className="flex flex-wrap gap-4">
            <li>
              <a href='javascript:void(0)' className='text-gray-500 text-sm font-semibold hover:underline'>Terms of Service</a>
            </li>
            <li>
              <a href='javascript:void(0)' className='text-gray-500 text-sm font-semibold hover:underline'>Privacy Policy</a>
            </li>
            <li>
              <a href='javascript:void(0)' className='text-gray-500 text-sm font-semibold hover:underline'>Security</a>
            </li>
          </ul>
          <p className='text-sm text-gray-500 ml-auto max-lg:mt-4'>Copyright © 2024<a href='#'
            className="hover:underline mx-1">DressUp</a>All Rights Reserved.</p>
        </div>
      </div>
    </footer>
  )
